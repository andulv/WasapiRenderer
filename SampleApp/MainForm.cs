...
namespace WasapiRendererFilter.Sample
{
  ...
  public class MainForm : System.Windows.Forms.Form
  {
    ...
    private IWasapiRendererFilter wasapiRenderer;
    ...
    private void PlayMovieInWindow(string filename)
    {
      ...
      this.wasapiRenderer = (IWasapiRendererFilter)Activator.CreateInstance(Type.GetTypeFromCLSID(WasapiRendererFilter.ClsId));
      //hr = this.graphBuilder.AddFilter((IBaseFilter)this.wasapiRenderer, "WASAPI Audio Renderer");
